...
class ApiService {
  ...
  async createStaff(data: {
    ...
    email?: string;
    phone?: string;
    languages?: Array<{language_code: string, cefr_level: string}>;
  }) {
  ...
  async updateStaff(staffId: number, data: any) {
  ...
  async updateStaffContactConfig(staffId: number, config: {
    preferred_contact_method?: string;
    response_time_hours?: number;
    contact_enabled?: boolean;
  }) {
    return this.request(`/staff/${staffId}/contact-config`, {
      method: 'PUT',
