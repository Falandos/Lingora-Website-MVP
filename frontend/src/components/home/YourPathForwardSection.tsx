        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Whether you're seeking professional services or offering them, we've made your journey simple and effective.
            </p>
          </div>
              ...
              <div className="text-center">
                ...
                <div className="space-y-4 mb-8 text-left">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700"><strong>Search</strong> by service and language</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-blue-600 font-bold text-sm">2</span>
                    </div>
                    <span className="text-gray-700"><strong>Connect</strong> with verified professionals</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <span className="text-blue-600 font-bold text-sm">3</span>
                    </div>
                    <span className="text-gray-700"><strong>Book</strong> your appointment or service</span>
                  </div>
                </div>
              ...
              <div className="text-center pt-4">
                ...
                <div className="space-y-4 mb-8 text-left">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700"><strong>Reach</strong> multilingual clients who need your services</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-4 h-4 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700"><strong>Get verified</strong> through our KVK/BTW validation system</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-4 h-4 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700"><strong>Easy setup</strong> with AI-powered profile optimization</span>
                  </div>
                </div>

                {/* Pricing highlight */}
                <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4 mb-6">
                  <div className="text-3xl font-bold text-primary-600 mb-1">3 Months FREE</div>
                  <div className="text-sm text-gray-600">Complete trial period</div>
                </div>
                ...
                <p className="text-sm text-gray-500">
                  Then only <span className="font-semibold">€9.99/month</span> • Cancel anytime
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 mt-16 pt-8 border-t border-green-200">
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span className="text-sm font-medium">KVK Verified Businesses</span>
            </div>
